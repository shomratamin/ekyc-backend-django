...
gFlow.ComponentsGroup['Giga EKYC Components'] =
...
//display
gFlow.Components.extend("_base", "_base", {
	 properties: [
     {
        key: "display_header",
        inputtype: SectionInput,
...
gFlow.Components.extend("_base", "html/container", {
    classes: ["container", "container-fluid"],
    image: "/static/gflow/libs/builder/icons/container.svg",
...
gFlow.Components.extend("_base", "html/heading", {
    image: "/static/gflow/libs/builder/icons/heading.svg",
    name: "Heading",
...
gFlow.Components.extend("_base", "html/link", {
    nodes: ["a"],
    name: "Link",
    html: '<a href="#" class="d-inline-block"><span>Link</span></a>',
	image: "/static/gflow/libs/builder/icons/link.svg",
    properties: [{
        name: "Url",
        key: "href",
        htmlAttr: "href",
...
gFlow.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="/static/gflow/libs/builder/icons/image.svg" height="128" width="128">',
    /*
    ...
    image: "/static/gflow/libs/builder/icons/image.svg",
    properties: [{
        name: "Image",
        key: "src",
        htmlAttr: "src",
...
gFlow.Components.add("html/hr", {
    image: "/static/gflow/libs/builder/icons/hr.svg",
    nodes: ["hr"],
    name: "Horizontal Rule",
    html: "<hr>"
});
gFlow.Components.extend("_base", "html/label", {
    name: "Label",
    nodes: ["label"],
...
gFlow.Components.extend("_base", "html/button", {
    classes: ["btn", "btn-link"],
    name: "Button",
    image: "/static/gflow/libs/builder/icons/button.svg",
...
gFlow.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
    image: "/static/gflow/libs/builder/icons/button_group.svg",
...
gFlow.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
    image: "/static/gflow/libs/builder/icons/button_toolbar.svg",
...
gFlow.Components.extend("_base","html/alert", {
    classes: ["alert"],
    name: "Alert",
    image: "/static/gflow/libs/builder/icons/alert.svg",
...
gFlow.Components.extend("_base", "html/badge", {
    classes: ["badge"],
    image: "/static/gflow/libs/builder/icons/badge.svg",
    name: "Badge",
...
gFlow.Components.extend("_base", "html/card", {
    classes: ["card"],
    image: "/static/gflow/libs/builder/icons/panel.svg",
    name: "Card",
    html: '<div class="card">\
...
gFlow.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: "/static/gflow/libs/builder/icons/list_group.svg",
    classes: ["list-group"],
    html: '<ul class="list-group">\n  <li class="list-group-item">\n    <span class="badge">14</span>\n    Cras justo odio\n  </li>\n  <li class="list-group-item">\n    <span class="badge">2</span>\n    Dapibus ac facilisis in\n  </li>\n  <li class="list-group-item">\n    <span class="badge">1</span>\n    Morbi leo risus\n  </li>\n</ul>'
});
gFlow.Components.extend("_base", "html/listitem", {
    name: "List Item",
    classes: ["list-group-item"],
    html: '<li class="list-group-item"><span class="badge">14</span> Cras justo odio</li>'
});
gFlow.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
    image: "/static/gflow/libs/builder/icons/breadcrumbs.svg",
...
gFlow.Components.extend("_base", "html/breadcrumbitem", {
...
gFlow.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
    image: "/static/gflow/libs/builder/icons/pagination.svg",
...
gFlow.Components.extend("_base", "html/pageitem", {
	classes: ["page-item"],
...
gFlow.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
    image: "/static/gflow/libs/builder/icons/progressbar.svg",
...
gFlow.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
    image: "/static/gflow/libs/builder/icons/jumbotron.svg",
    name: "Jumbotron",
...
gFlow.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
    image: "/static/gflow/libs/builder/icons/navbar.svg",
    name: "Nav Bar",
...
gFlow.Components.extend("_base", "html/form", {
    nodes: ["form"],
    image: "/static/gflow/libs/builder/icons/form.svg",
    name: "Form",
...
gFlow.Components.extend("_base", "html/textinput", {
    name: "Text Input",
	attributes: {"type":"text"},
    image: "/static/gflow/libs/builder/icons/text_input.svg",
...
gFlow.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
    image: "/static/gflow/libs/builder/icons/select_input.svg",
		...
		$(node).find('option').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						option.remove();
						gFlow.Components.render("html/selectinput");
						return node;
					}
...
gFlow.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: "/static/gflow/libs/builder/icons/text_area.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>'
});
gFlow.Components.extend("_base", "html/radiobutton", {
    name: "Radio Button",
	attributes: {"type":"radio"},
    image: "/static/gflow/libs/builder/icons/radio.svg",
...
gFlow.Components.extend("_base", "html/checkbox", {
    name: "Checkbox",
    attributes: {"type":"checkbox"},
    image: "/static/gflow/libs/builder/icons/checkbox.svg",
...
gFlow.Components.extend("_base", "html/fileinput", {
    name: "Input group",
...
gFlow.Components.extend("_base", "html/table", {
    nodes: ["table"],
    classes: ["table"],
    image: "/static/gflow/libs/builder/icons/table.svg",
    name: "Table",
...
gFlow.Components.extend("_base", "html/tablerow", {
    nodes: ["tr"],
    name: "Table Row",
...
gFlow.Components.extend("_base", "html/tablecell", {
    nodes: ["td"],
    name: "Table Cell",
    html: "<td>Cell</td>"
});
gFlow.Components.extend("_base", "html/tableheadercell", {
    nodes: ["th"],
    name: "Table Header Cell",
    html: "<th>Head</th>"
});
gFlow.Components.extend("_base", "html/tablehead", {
    nodes: ["thead"],
    name: "Table Head",
...
gFlow.Components.extend("_base", "html/tablebody", {
    nodes: ["tbody"],
    name: "Table Body",
    html: "<tbody><tr><td>Cell 1</td><td>Cell 2</td><td>Cell 3</td></tr></tbody>"
});

gFlow.Components.add("html/gridcolumn", {
    name: "Grid Column",
    image: "/static/gflow/libs/builder/icons/grid_row.svg",
    classesRegex: ["col-"],
...
gFlow.Components.add("html/gridrow", {
    name: "Grid Row",
    image: "/static/gflow/libs/builder/icons/grid_row.svg",
    classes: ["row"],
		...
		$(node).find('[class*="col-"]').each(function() {
			...
			properties.push({
				...
				onChange: function(node, value, input) {
					...
					{
						column.remove();
						gFlow.Components.render("html/gridrow");
						return node;
					}
...
gFlow.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
	image: "/static/gflow/libs/builder/icons/paragraph.svg",
...
gFlow.Components.extend("_base", "html/video", {
    nodes: ["video"],
    name: "Video",
    ...
    dragHtml: '<img  width="320" height="240" src="/static/gflow/libs/builder/icons/video.svg">',
	image: "/static/gflow/libs/builder/icons/video.svg",
    properties: [{
        name: "Src",
        child: "source",
        key: "src",
