...
gFlow.ComponentsGroup['Widgets'] = ["widgets/googlemaps", "widgets/video", "widgets/chartjs", "widgets/facebookpage", "widgets/paypal", "widgets/instagram", "widgets/twitter"/*, "widgets/facebookcomments"*/];

gFlow.Components.extend("_base", "widgets/googlemaps", {
    name: "Google Maps",
    attributes: ["data-component-maps"],
    image: "/static/gflow/libs/builder/icons/map.svg",
    dragHtml: '<img src="/static/gflow/libs/builder/icons/maps.png">',
...
gFlow.Components.extend("_base", "widgets/video", {
    name: "Video",
    attributes: ["data-component-video"],
    image: "/static/gflow/libs/builder/icons/video.svg",
    dragHtml: '<img src="/static/gflow/libs/builder/icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
gFlow.Components.extend("_base", "widgets/facebookcomments", {
    name: "Facebook Comments",
    attributes: ["data-component-facebookcomments"],
    image: "/static/gflow/libs/builder/icons/facebook.svg",
    dragHtml: '<img src="/static/gflow/libs/builder/icons/facebook.svg">',
...
gFlow.Components.extend("_base", "widgets/instagram", {
    name: "Instagram",
    attributes: ["data-component-instagram"],
    image: "/static/gflow/libs/builder/icons/instagram.svg",
    drophtml: '<img src="/static/gflow/libs/builder/icons/instagram.png">',
...
gFlow.Components.extend("_base", "widgets/twitter", {
    name: "Twitter",
    attributes: ["data-component-twitter"],
    image: "/static/gflow/libs/builder/icons/twitter.svg",
    dragHtml: '<img src="/static/gflow/libs/builder/icons/twitter.svg">',
...
gFlow.Components.extend("_base", "widgets/paypal", {
    name: "Paypal",
    attributes: ["data-component-paypal"],
    image: "/static/gflow/libs/builder/icons/paypal.svg",
...
\
				...
				<input type="hidden" name="item_name" value="gFlowJs">\
...
gFlow.Components.extend("_base", "widgets/facebookpage", {
    name: "Facebook Page Plugin",
    attributes: ["data-component-facebookpage"],
    image: "/static/gflow/libs/builder/icons/facebook.svg",
    dropHtml: '<img src="/static/gflow/libs/builder/icons/facebook.png">',
...
gFlow.Components.extend("_base", "widgets/chartjs", {
    name: "Chart.js",
    attributes: ["data-component-chartjs"],
    image: "/static/gflow/libs/builder/icons/chart.svg",
	dragHtml: '<img src="/static/gflow/libs/builder/icons/chart.svg">',
